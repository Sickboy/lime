...
/* __string_template__2f2ea80ad0da30d70cca1be465e467e93576b655315a79bf2f4c4271947800f1 */
class __TwigTemplate_4fe3eb880edd6b0b11fa9f83030fff8a9ec7c26dcc09c79b878d4615d7cd7b8f extends Twig_Template
{
    ...
    ";
        ...
        echo " ";
        if (($this->getAttribute($this->getAttribute(($context["aSurveyInfo"] ?? null), "options", array()), "brandlogo", array()) == "false")) {
            echo "brand-logo";
        }
        echo "\" ";
    ...
    {
        return "__string_template__2f2ea80ad0da30d70cca1be465e467e93576b655315a79bf2f4c4271947800f1";
    }
    ...
    {% endblock %}
    <body style=\"padding-top: 90px;\" class=\" {{ aSurveyInfo.class.body }} font-{{  aSurveyInfo.options.font }} lang-{{aSurveyInfo.languagecode}} {{aSurveyInfo.surveyformat}} {% if( aSurveyInfo.options.brandlogo == \"false\") %}brand-logo{%endif%}\" {{ aSurveyInfo.attr.body }} >
...
</html>", "__string_template__2f2ea80ad0da30d70cca1be465e467e93576b655315a79bf2f4c4271947800f1", "");
    }
}
