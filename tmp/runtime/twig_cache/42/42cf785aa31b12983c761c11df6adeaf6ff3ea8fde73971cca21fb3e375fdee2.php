...
/* __string_template__bd5b7036880dca3124af79dd3074bb0d3cc5fb7b7662df46bf8fce44af626663 */
class __TwigTemplate_ed2ce752767bfba7bb030fc4dbe65c605552be1441d6d8de213fb111540ca63c extends Twig_Template
{
...
";
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        // line 115
        echo "                    ";
        $this->loadTemplate("./subviews/content/outerframe.twig", "__string_template__bd5b7036880dca3124af79dd3074bb0d3cc5fb7b7662df46bf8fce44af626663", 115)->display(array_merge($context, array("include_content" => ($context["sViewContent"] ?? null))));
        // line 116
        echo "                ";
    }
    ...
    {
        return "__string_template__bd5b7036880dca3124af79dd3074bb0d3cc5fb7b7662df46bf8fce44af626663";
    }
...
<html lang=\"{{ aSurveyInfo.languagecode }}\" dir=\"{{ aSurveyInfo.dir }}\" class=\"{{ aSurveyInfo.languagecode }} dir-{{ aSurveyInfo.dir }} {{ aSurveyInfo.class.html }}\" {{ aSurveyInfo.attr.html }}>
    ...
    {% endblock %}
    <body style=\"padding-top: 90px;\" class=\" {{ aSurveyInfo.class.body }}  lang-{{aSurveyInfo.languagecode}} font-{{  aSurveyInfo.options.font }} {{aSurveyInfo.surveyformat}} {% if( aSurveyInfo.options.brandlogo == \"on\") %}brand-logo{%endif%}\" {{ aSurveyInfo.attr.body }} >
