...
/* __string_template__6d587a018c232df053d3bc791e002befea5276ce16048667dcc92d5b45abd570 */
class __TwigTemplate_6ae8b2b1ac9db086a8ab54709c319cac93718ffc81d950ec93258f0e287bf2d8 extends Twig_Template
{
    ...
    ";
        ...
        echo " ";
        if (($this->getAttribute($this->getAttribute(($context["aSurveyInfo"] ?? null), "options", array()), "brandlogo", array()) == "off")) {
            echo "brand-logo";
        }
        echo "\" ";
    ...
    {
        return "__string_template__6d587a018c232df053d3bc791e002befea5276ce16048667dcc92d5b45abd570";
    }
    ...
    {
        return array (  94 => 9,  91 => 8,  84 => 4,  82 => 3,  79 => 2,  70 => 11,  68 => 8,  50 => 6,  48 => 2,  45 => 1,);
    }
    ...
    {% endblock %}
    <body style=\"padding-top: 90px;\" class=\" {{ aSurveyInfo.class.body }} font-{{  aSurveyInfo.options.font }} lang-{{aSurveyInfo.languagecode}} {{aSurveyInfo.surveyformat}} {% if( aSurveyInfo.options.brandlogo == \"off\") %}brand-logo{%endif%}\" {{ aSurveyInfo.attr.body }} >
...
</html>", "__string_template__6d587a018c232df053d3bc791e002befea5276ce16048667dcc92d5b45abd570", "");
    }
}
