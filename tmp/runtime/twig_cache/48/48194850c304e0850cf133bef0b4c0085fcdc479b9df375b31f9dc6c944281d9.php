...
class __TwigTemplate_3957858de3022286c97138de6119d0dae9846db00a340572f9f38e3d80495665 extends Twig_Template
{
...
";
    ...
    {
        return array (  125 => 49,  117 => 48,  112 => 47,  109 => 45,  103 => 42,  96 => 41,  94 => 40,  91 => 38,  85 => 35,  80 => 34,  78 => 33,  75 => 31,  68 => 27,  62 => 26,  56 => 25,  52 => 24,  49 => 23,  47 => 22,  43 => 19,);
    }
...
{% if aQuestion.mandatory != '' %}
    ...
    <div class=\" pull-left\" {{ aSurveyInfo.attr.questionasterix }} >
...
{% if (aShow.question_number) %}
    <span class='' {{ aSurveyInfo.attr.questionnumber }} >
        {{ aQuestion.number }}
    </span>
{% endif %}
...
<div class=\"\" {{ aSurveyInfo.attr.questiontext }}>
    <div id=\"ls-question-text-{{ aQuestion.SGQ }}\" class=\"{{ aSurveyInfo.class.lsquestiontext }}\" {{ aSurveyInfo.attr.lsquestiontext }}>
        {{ aQuestion.text | raw }}
    </div>
</div>
", "./subviews/survey/question_subviews/question_text_content.twig", "/var/www/html/ankiety/v3/themes/survey/umk2/views/subviews/survey/question_subviews/question_text_content.twig");
    }
}
